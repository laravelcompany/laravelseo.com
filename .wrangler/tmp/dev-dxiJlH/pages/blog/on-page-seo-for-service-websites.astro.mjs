...
const $$OnPageSeoForServiceWebsites = createComponent(($$result, $$props, $$slots) => {
  const title = "On-Page SEO for Service Websites: A Practical Checklist";
  const description = "A detailed on-page SEO guide for service businesses covering content depth, titles, metadata, internal links, load speed, local intent, and launch strategy.";
  const date = "2026-06-29";
  return renderTemplate`${renderComponent($$result, "BlogPost", $$BlogPost, { "title": title, "description": description, "date": date, "category": "Local SEO", "readTime": "14 min read", "tags": "on-page seo, local seo, service websites, content optimization, internal linking" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="prose prose-lg prose-invert max-w-none"> <h2>Introduction</h2> <p>
...
</p> <h2>Title Tags And Meta Descriptions</h2> <p>
...
</p> <h2>Internal Linking That Actually Helps</h2> <p>
...
</p> <h2>Page Load Speed Still Matters</h2> <p>
...
</p> <h2>Technical SEO Basics You Should Not Skip</h2> <p>
...
</p> <h2>Exact Match Keywords And Local SEO</h2> <p>
...
</p> <h2>How Many Pages Should A New Site Launch With?</h2> <p>
...
</p> <h2>How To Structure The Site For Growth</h2> <p>
...
Review your most important pages from the <a href="/" class="text-violet-400 hover:text-violet-300">homepage</a> outward, then use the same logic to inspect every core service page. If you need a second reference point, come back through the <a href="/" class="text-violet-400 hover:text-violet-300">homepage</a> again and ask whether each page is clear enough to deserve a click, a crawl, and a conversion.
</p> </div> ` })}`;
}, "/home/stefan/Projects/laravelseo.com/src/pages/blog/on-page-seo-for-service-websites.astro", void 0);

const $$file = "/home/stefan/Projects/laravelseo.com/src/pages/blog/on-page-seo-for-service-websites.astro";
const $$url = "/blog/on-page-seo-for-service-websites";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$OnPageSeoForServiceWebsites,
  file: $$file,
  url: $$url
