...
import { g as getDefaultExportFromCjs } from './astro/server_BA1YRW7y.mjs';
...
async function check(Component, props, children) {
  ...
  if (Component.prototype != null && typeof Component.prototype.render === "function") {
    return React2.Component.isPrototypeOf(Component) || React2.PureComponent.isPrototypeOf(Component);
  }
...
async function renderToStaticMarkup(Component, props, { default: children, ...slotted }, metadata) {
  ...
  for (const [key, value] of Object.entries(slotted)) {
    ...
    slots[name] = React2.createElement(static_html_default, {
  ...
  if (newChildren != null) {
    newProps.children = React2.createElement(static_html_default, {
      hydrate: needsHydration(metadata),
      value: newChildren
    });
  }
  ...
  const vnode = React2.createElement(Component, newProps);
  const renderOptions = {
...
export { React2 as R, reactExports as a, React as b, requireReactDom as c, renderers as r };
